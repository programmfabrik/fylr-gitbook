...
* [API](for-developers/api/README.md)
  ...
  * [Endpoints](for-developers/api/endpoints/README.md)
    * [/api/collection](for-developers/api/endpoints/collection/README.md)
      * [/collection/list](for-developers/api/endpoints/collection/list.md)
      * [/collection/objects](for-developers/api/endpoints/collection/objects.md)
      * [/collection/push](for-developers/api/endpoints/collection/push.md)
      * [/collection/remove](for-developers/api/endpoints/collection/remove.md)
      * [/collection/splice](for-developers/api/endpoints/collection/splice.md)
    * [/api/config](for-developers/api/endpoints/config/README.md)
      * [/config/list](for-developers/api/endpoints/config/list.md)
    * [/api/db](for-developers/api/endpoints/api-db.md)
    * [/api/db_info](for-developers/api/endpoints/api-db_info.md)
    * [/api/eas](for-developers/api/endpoints/eas/README.md)
      * [/eas/download](for-developers/api/endpoints/eas/download.md)
      * [/eas/iiif](for-developers/api/endpoints/eas/iiif.md)
      * [/eas/produce](for-developers/api/endpoints/eas/produce.md)
      * [/eas/put](for-developers/api/endpoints/eas/put.md)
      * [/eas/rput](for-developers/api/endpoints/eas/rput.md)
      * [/eas/rput/bulk](for-developers/api/endpoints/eas/rput-bulk.md)
      * [/eas/zoom](for-developers/api/endpoints/eas/zoom.md)
    ...
    * [/api/hotfolder](for-developers/api/endpoints/api-hotfolder.md)
    ...
    * [/api/plugin](for-developers/api/endpoints/plugin/README.md)
      * [/plugin/manage](for-developers/api/endpoints/plugin/manage.md)
    ...
    * [/api/system](for-developers/api/endpoints/system/README.md)
      * [/system/sendmail](for-developers/api/endpoints/system/sendmail.md)
      * [/system/sendmail/test](for-developers/api/endpoints/system/sendmail-test.md)
      * [/system/share_link](for-developers/api/endpoints/system/share_link.md)
    ...
    * [/api/well-known](for-developers/api/endpoints/api-well-known.md)
