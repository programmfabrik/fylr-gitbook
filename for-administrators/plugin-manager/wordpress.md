...
Enter the URL of the wordpress-plugin for fylr. You can get this URL from us, [support@programmfabrik.de](mailto:support@rogrammfabrik.de). To be allowed to use this plugin, a fylr license from us is needed, which explicitly allows this plugin and which is subject to a charge.
