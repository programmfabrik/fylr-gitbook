...
| Audio | small / preview | 250 px / 1000 px preview image of the embedded cover art (files without cover art get no preview image) |
| Audio | aac | the audio re-encoded as AAC in an MP4 container (`.m4a`) |
