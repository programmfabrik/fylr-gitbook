...
### `POST /instances/{id}/activate` — Re-apply the customer admin

{% openapi src="../.gitbook/assets/fylr-supervisor-openapi.yml" path="/instances/{id}/activate" method="post" %}
[fylr-supervisor-openapi.yml](../.gitbook/assets/fylr-supervisor-openapi.yml)
{% endopenapi %}

## Deployments

Run a release or branch build as a throwaway instance: upload a dist archive, get a running instance; re-upload swaps the binary and rolls.

### `PUT /deployments/{name}` — Create or update a deployment

{% openapi src="../.gitbook/assets/fylr-supervisor-openapi.yml" path="/deployments/{name}" method="put" %}
[fylr-supervisor-openapi.yml](../.gitbook/assets/fylr-supervisor-openapi.yml)
{% endopenapi %}

### `DELETE /deployments/{name}` — Delete a deployment

{% openapi src="../.gitbook/assets/fylr-supervisor-openapi.yml" path="/deployments/{name}" method="delete" %}
[fylr-supervisor-openapi.yml](../.gitbook/assets/fylr-supervisor-openapi.yml)
{% endopenapi %}
