...
<table border="1">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td rowspan="5"><code>processing</code></td>
            <td rowspan="5">A worker is processing the file.</td>
        </tr>
        <tr>
            <td>
                <p><code>pending_produce_internal</code></p>
            </td>
        </tr>
        <tr>
            <td>
                <p><code>pending_manual_produce_internal</code></p>
            </td>
        </tr>
        <tr>
            <td>
                <p><code>pending_original_produce_internal</code></p>
            </td>
        </tr>
        <tr>
            <td>
                <p><code>pending_metadata_internal</code></p>
            </td>
        </tr>
        <tr>
            ...
            <td rowspan="4"><code>sync</code></td>
            <td rowspan="4">
                <p>Processing of the file in file workers is done. Further information are still calculated for the database.</p>
                <p>Files in states <code>sync</code> and <code>pending_checksum</code> can already be exported.</p>
            </td>
        </tr>
        <tr>
            <td>
                <p><code>pending_copy_internal</code></p>
            </td>
        </tr>
        <tr>
            <td>
                <p><code>pending_move_internal</code></p>
            </td>
        </tr>
        <tr>
            <td>
                <p><code>pending_checksum</code></p>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>There was an error during conversion. See <a data-mention href="files-and-version-production.md#errors-and-solutions">#errors-and-solutions</a> for more information and possible solutions.</td>
        </tr>
    </tbody>
</table>
