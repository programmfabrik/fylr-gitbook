---
description: >-
  The anatomy of a record in the /api/v1/db JSON — the system fields every record
  carries, the difference between _id / _system_object_id / _global_object_id,
  and how field values (linked, nested, localized) serialize.
---
