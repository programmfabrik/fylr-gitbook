...
{% openapi src="../../../.gitbook/assets/fylr-openapi.yml" path="/mask/{version}" method="get" %}
[fylr-openapi.yml](../../../.gitbook/assets/fylr-openapi.yml)
{% endopenapi %}

### `GET /mask/{version}/{mask}` — Retrieve a single mask of a datamodel version.

{% openapi src="../../../.gitbook/assets/fylr-openapi.yml" path="/mask/{version}/{mask}" method="get" %}
[fylr-openapi.yml](../../../.gitbook/assets/fylr-openapi.yml)
{% endopenapi %}

### `POST /mask/HEAD` — Write masks into the working datamodel (`HEAD`).

{% openapi src="../../../.gitbook/assets/fylr-openapi.yml" path="/mask/HEAD" method="post" %}
[fylr-openapi.yml](../../../.gitbook/assets/fylr-openapi.yml)
{% endopenapi %}
