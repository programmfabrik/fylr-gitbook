...
{% openapi src="../../../.gitbook/assets/fylr-openapi.yml" path="/publish" method="get" %}
[fylr-openapi.yml](../../../.gitbook/assets/fylr-openapi.yml)
{% endopenapi %}

### `POST /publish` — Record one or more publishings.

{% openapi src="../../../.gitbook/assets/fylr-openapi.yml" path="/publish" method="post" %}
[fylr-openapi.yml](../../../.gitbook/assets/fylr-openapi.yml)
{% endopenapi %}

### `GET /publish/{systemObjectId}` — Retrieve a single publish record by its id.

{% openapi src="../../../.gitbook/assets/fylr-openapi.yml" path="/publish/{systemObjectId}" method="get" %}
[fylr-openapi.yml](../../../.gitbook/assets/fylr-openapi.yml)
{% endopenapi %}

### `DELETE /publish/{publishId}` — Delete a publish record.

{% openapi src="../../../.gitbook/assets/fylr-openapi.yml" path="/publish/{publishId}" method="delete" %}
[fylr-openapi.yml](../../../.gitbook/assets/fylr-openapi.yml)
{% endopenapi %}
