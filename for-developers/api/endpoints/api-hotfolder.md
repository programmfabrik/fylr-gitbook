...
{% openapi src="../../../.gitbook/assets/fylr-openapi.yml" path="/hotfolder/{collectionUuid}/{path}" method="get" %}
...
{% openapi src="../../../.gitbook/assets/fylr-openapi.yml" path="/hotfolder/{collectionUuid}/{path}" method="put" %}
[fylr-openapi.yml](../../../.gitbook/assets/fylr-openapi.yml)
{% endopenapi %}
