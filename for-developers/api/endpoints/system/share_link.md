...
{% openapi src="../../../../.gitbook/assets/fylr-openapi.yml" path="/system/share_link" method="post" %}
[fylr-openapi.yml](../../../../.gitbook/assets/fylr-openapi.yml)
{% endopenapi %}

### `GET /system/share_link/{id}`

{% openapi src="../../../../.gitbook/assets/fylr-openapi.yml" path="/system/share_link/{id}" method="get" %}
[fylr-openapi.yml](../../../../.gitbook/assets/fylr-openapi.yml)
{% endopenapi %}
