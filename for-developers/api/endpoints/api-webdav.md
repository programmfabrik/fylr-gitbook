...
{% swagger src="./fylr-openapi.yml" path="/WebDAV/{collectionUuid}/{path}" method="get" %}
...
{% swagger src="./fylr-openapi.yml" path="/WebDAV/{collectionUuid}/{path}" method="post" %}
[fylr-openapi.yml](./fylr-openapi.yml)
{% endswagger %}

### `PUT /WebDAV/{collectionUuid}/{path}` — Upload a file and link it to the collection.
{% swagger src="./fylr-openapi.yml" path="/WebDAV/{collectionUuid}/{path}" method="put" %}
[fylr-openapi.yml](./fylr-openapi.yml)
{% endswagger %}

### `DELETE /WebDAV/{collectionUuid}/{path}` — Delete a file.
{% swagger src="./fylr-openapi.yml" path="/WebDAV/{collectionUuid}/{path}" method="delete" %}
[fylr-openapi.yml](./fylr-openapi.yml)
{% endswagger %}

### `HEAD /WebDAV/{collectionUuid}/{path}` — Probe a file's existence and metadata.
{% swagger src="./fylr-openapi.yml" path="/WebDAV/{collectionUuid}/{path}" method="head" %}
[fylr-openapi.yml](./fylr-openapi.yml)
{% endswagger %}

### `OPTIONS /WebDAV/{collectionUuid}/{path}` — Advertise the supported WebDAV methods for this resource.
{% swagger src="./fylr-openapi.yml" path="/WebDAV/{collectionUuid}/{path}" method="options" %}
[fylr-openapi.yml](./fylr-openapi.yml)
{% endswagger %}
