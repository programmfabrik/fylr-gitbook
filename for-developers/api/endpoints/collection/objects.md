...
{% openapi src="../../../../.gitbook/assets/fylr-openapi.yml" path="/collection/objects/{collection_id}" method="get" %}
[fylr-openapi.yml](../../../../.gitbook/assets/fylr-openapi.yml)
{% endopenapi %}

### `POST /collection/objects/{collection_id}` — Replace objects of a collection.

{% openapi src="../../../../.gitbook/assets/fylr-openapi.yml" path="/collection/objects/{collection_id}" method="post" %}
[fylr-openapi.yml](../../../../.gitbook/assets/fylr-openapi.yml)
{% endopenapi %}
