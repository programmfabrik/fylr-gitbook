...
{% swagger src="./fylr-openapi.yml" path="/group" method="get" %}
[fylr-openapi.yml](./fylr-openapi.yml)
{% endswagger %}

### `POST /group` — Create or update one or more groups.
{% swagger src="./fylr-openapi.yml" path="/group" method="post" %}
[fylr-openapi.yml](./fylr-openapi.yml)
{% endswagger %}

### `PUT /group` — Create or update one or more groups (alias for POST).
{% swagger src="./fylr-openapi.yml" path="/group" method="put" %}
[fylr-openapi.yml](./fylr-openapi.yml)
{% endswagger %}

### `GET /group/{id}` — Retrieve a single group by id.
{% swagger src="./fylr-openapi.yml" path="/group/{id}" method="get" %}
[fylr-openapi.yml](./fylr-openapi.yml)
{% endswagger %}

### `DELETE /group/{id}` — Delete a group by id.
{% swagger src="./fylr-openapi.yml" path="/group/{id}" method="delete" %}
[fylr-openapi.yml](./fylr-openapi.yml)
{% endswagger %}
