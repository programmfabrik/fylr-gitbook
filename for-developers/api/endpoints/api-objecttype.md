...
{% swagger src="./fylr-openapi.yml" path="/objecttype" method="get" %}
[fylr-openapi.yml](./fylr-openapi.yml)
{% endswagger %}

### `POST /objecttype` — Create or update the settings of one or more objecttypes.
{% swagger src="./fylr-openapi.yml" path="/objecttype" method="post" %}
[fylr-openapi.yml](./fylr-openapi.yml)
{% endswagger %}

### `GET /objecttype/{id}` — Retrieve a single objecttype.
{% swagger src="./fylr-openapi.yml" path="/objecttype/{id}" method="get" %}
[fylr-openapi.yml](./fylr-openapi.yml)
{% endswagger %}

### `GET /objecttype/{id}/stats` — Asset statistics for an objecttype.
{% swagger src="./fylr-openapi.yml" path="/objecttype/{id}/stats" method="get" %}
[fylr-openapi.yml](./fylr-openapi.yml)
{% endswagger %}
