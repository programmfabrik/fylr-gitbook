...
{% openapi src="../../../.gitbook/assets/fylr-openapi.yml" path="/l10n/static/{lang}.json" method="get" %}
[fylr-openapi.yml](../../../.gitbook/assets/fylr-openapi.yml)
{% endopenapi %}

### `GET /l10n/user/{version}` — Datamodel translations for a version.

{% openapi src="../../../.gitbook/assets/fylr-openapi.yml" path="/l10n/user/{version}" method="get" %}
[fylr-openapi.yml](../../../.gitbook/assets/fylr-openapi.yml)
{% endopenapi %}

### `POST /l10n/user/HEAD` — Update HEAD datamodel translations.

{% openapi src="../../../.gitbook/assets/fylr-openapi.yml" path="/l10n/user/HEAD" method="post" %}
[fylr-openapi.yml](../../../.gitbook/assets/fylr-openapi.yml)
{% endopenapi %}
