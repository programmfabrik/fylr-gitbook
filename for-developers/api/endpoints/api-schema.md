...
{% openapi src="../../../.gitbook/assets/fylr-openapi.yml" path="/schema/user/{version}" method="get" %}
[fylr-openapi.yml](../../../.gitbook/assets/fylr-openapi.yml)
{% endopenapi %}

### `POST /schema/user/HEAD` — Update the working datamodel (`HEAD`).

{% openapi src="../../../.gitbook/assets/fylr-openapi.yml" path="/schema/user/HEAD" method="post" %}
[fylr-openapi.yml](../../../.gitbook/assets/fylr-openapi.yml)
{% endopenapi %}

### `POST /schema/commit` — Commit the working datamodel (`HEAD`).

{% openapi src="../../../.gitbook/assets/fylr-openapi.yml" path="/schema/commit" method="post" %}
[fylr-openapi.yml](../../../.gitbook/assets/fylr-openapi.yml)
{% endopenapi %}
