...
| Create Presentation      | Turns the collection into a presentation. For all options [see below](collections-and-presentations.md#presentation-settings).                                     |
| Upload                   | Only available for collections with [upload enabled](collections-and-presentations.md#upload-and-file-system-connect). Click to upload files into this collection. |
...
| Print                    | Click to open the print settings and download a pdf file with all records of the collection.                                                                       |
| Share Collection         | Click to open the [sharing options](collections-and-presentations.md#sharing).                                                                                     |
| Settings                 | Click to open the [settings](collections-and-presentations.md#collection-settings) of the collection.                                                              |
...
| Default View    | Default view for the records in the collection. Will be used when opening a collection. See [collection detail](collections-and-presentations.md#collection-detail). |
...
| Email             | Activate to send an email to the recipient (provided that the user has specified an email).                                                                                                                                                                                |
...
| Pool                    | Select the pool the files should be created in.                                                                                              |
...
| Tags                    | Tags that should be set automatically when creating new records.                                                                             |
